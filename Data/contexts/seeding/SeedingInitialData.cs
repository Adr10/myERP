...
namespace myERP.Data.contexts.seeding
{
    public static class SeedingInitialData
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            var accion = new Genero { Id = 1, Nombre = "Acción" };
            var animacion = new Genero { Id = 2, Nombre = "Animación" };
            var comedia = new Genero { Id = 3, Nombre = "Comedia" };
            var cienciaFiccion = new Genero { Id = 4, Nombre = "Ciencia ficción" };
            ...
            var agora = new Cine() { cineId = 1, Nombre = "Agora Mall", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-69.9388777, 18.4839233)) };
            var sambil = new Cine() { cineId = 2, Nombre = "Sambil", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-69.911582, 18.482455)) };
            var megacentro = new Cine() { cineId = 3, Nombre = "Megacentro", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-69.856309, 18.506662)) };
            var acropolis = new Cine() { cineId = 4, Nombre = "Acropolis", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-69.939248, 18.469649)) };
            ...
            var keanuReevesMatrix = new ActorPelicula
            {
            ...
            var avengersChrisEvans = new ActorPelicula
            {
            ...
            var avengersRobertDowney = new ActorPelicula
            {
            ...
            var avengersScarlettJohansson = new ActorPelicula
            {
            ...
            var tomHollandFFH = new ActorPelicula
            {
            ...
            var tomHollandNWH = new ActorPelicula
            {
                ActorId = tomHolland.Id,
            ...
            var samuelJacksonFFH = new ActorPelicula
            {
            ...
            modelBuilder.Entity<ActorPelicula>().HasData(samuelJacksonFFH, tomHollandFFH, tomHollandNWH, avengersRobertDowney, avengersScarlettJohansson,
